      ...
      <Popover className="relative h-full">
        <PopoverButton className="h-full">
          ...
          >
            ...
            <LuShoppingCart
              className={`cursor-pointer w-[18px] h-[18px] text-black transition-transform duration-500 hover:scale-125 `}
            />
        ...
        >
          <PopoverPanel
            static
            className="hidden small:block absolute top-8 right-0 bg-white border-[0.01px] text-[#b3b3b3] w-[420px] text-ui-fg-base"
              ...
              <>
                ...
                <div className="p-4 flex flex-col gap-y-4 text-small-regular">
                  <div className="flex items-center justify-between">
                    <span className="text-ui-fg-base font-semibold text-[#b3b3b3]">
                      Subtotal{" "}
